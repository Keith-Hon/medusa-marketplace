...
describe("Init command", () => {
    ...
    it("should update the setup of the actual project to use the medusa-extender", async () => {
        ...
        expect(existsSync(resolve(__dirname, "..", "fakeProject", "src", "modules", "example", "example.module.ts"))).toBe(true);
        expect(existsSync(resolve(__dirname, "..", "fakeProject", "src", "modules", "example", "example.service.ts"))).toBe(true);
        expect(existsSync(resolve(__dirname, "..", "fakeProject", "src", "modules", "example", "example.router.ts"))).toBe(true);
    });
});
