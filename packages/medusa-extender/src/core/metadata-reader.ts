    ...
    for (const module of modules) {
        ...
        for (const component of moduleImports) {
            ...
            if (subModuleImports) {
                ...
                componentMap = new ComponentMap([...Array.from(componentMap.entries()), ...Array.from(subComponentMap.entries())]);
                continue;
            }
 ...
 * @param component
 */
export function componentsMetadataReader<TComponentType = unknown>(component: Type): InjectableOptions<TComponentType> & { type: InjectableComponentTypes } {
