 ...
 */
export type InjectableComponentTypes = "validator" | "entity" | "repository" | "service" | "migration" | "router" | "middleware" | "subscriber";
 ...
 */
export type GetInjectableOption<TComponentType extends InjectableComponentTypes = InjectableComponentTypes> = (TComponentType extends Extract<InjectableComponentTypes, "entity">
 ...
 * Determine which options type it actually is depending on the component type.
 */
export type GetInjectableOptions<TComponentType extends InjectableComponentTypes = InjectableComponentTypes> = GetInjectableOption<TComponentType>[];
