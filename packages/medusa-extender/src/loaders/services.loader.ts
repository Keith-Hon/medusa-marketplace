...
export function registerService(container: MedusaContainer, serviceOptions: GetInjectableOption<"service">, configModule: Record<string, unknown>): void {
...
export function overrideService(container: MedusaContainer, serviceOptions: GetInjectableOption<"service">, configModule: Record<string, unknown>): void {
