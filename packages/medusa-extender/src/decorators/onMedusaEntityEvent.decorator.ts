...
export class OnMedusaEntityEvent {
    ...
    public Insert<TEntity extends Type>(entity: TEntity, options: EntityEventActionOptions = { async: false }): MethodDecorator {
        return this.buildDecorator("Insert", entity, options);
    }

    public Update<TEntity extends Type>(entity: TEntity, options: EntityEventActionOptions = { async: false }): MethodDecorator {
        return this.buildDecorator("Update", entity, options);
    }

    public Remove<TEntity extends Type>(entity: TEntity, options: EntityEventActionOptions = { async: false }): MethodDecorator {
        return this.buildDecorator("Remove", entity, options);
    }

    private buildDecorator<TEntity extends Type>(action: EntityActions, entity: TEntity, options: EntityEventActionOptions = { async: false }) {
