...
export class nestedReturnReasons1631800727788 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "return_reason" ADD "parent_return_reason_id" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "return_reason" DROP COLUMN "parent_return_reason_id"`);
    }
}
