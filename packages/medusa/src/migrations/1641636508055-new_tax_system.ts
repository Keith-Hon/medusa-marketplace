...
export class newTaxSystem1641636508055 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "region" ADD "gift_cards_taxable" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "region" ADD "automatic_taxes" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "region" ADD "tax_provider_id" character varying`);
        await queryRunner.query(`ALTER TABLE "line_item" ADD "is_return" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`UPDATE "line_item" SET "is_return" = true WHERE "id" IN (SELECT "id" from "line_item" WHERE "metadata"->>'is_return_line' = 'true')`);
        await queryRunner.query(`ALTER TABLE "order" ALTER COLUMN "tax_rate" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order" ALTER COLUMN "tax_rate" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "line_item" DROP COLUMN "is_return"`);
        await queryRunner.query(`ALTER TABLE "region" DROP COLUMN "tax_provider_id"`);
        await queryRunner.query(`ALTER TABLE "region" DROP COLUMN "automatic_taxes"`);
        await queryRunner.query(`ALTER TABLE "region" DROP COLUMN "gift_cards_taxable"`);
