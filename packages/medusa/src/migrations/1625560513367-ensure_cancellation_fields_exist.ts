...
export class ensureCancellationFieldsExist1625560513367 implements MigrationInterface {
    name = "ensureCancellationFieldsExist1625560513367";

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "swap" ADD "canceled_at" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TYPE "return_status_enum" RENAME TO "return_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "return_status_enum" AS ENUM('requested', 'received', 'requires_action', 'canceled')`);
