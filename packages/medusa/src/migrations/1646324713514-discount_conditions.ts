...
export class discountConditions1646324713514 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "discount_condition_type_enum" AS ENUM('products', 'product_types', 'product_collections', 'product_tags', 'customer_groups')`);
        await queryRunner.query(`CREATE TYPE "discount_condition_operator_enum" AS ENUM('in', 'not_in')`);
