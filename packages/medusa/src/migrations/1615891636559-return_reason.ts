...
export class returnReason1615891636559 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "return_item" ADD "reason_id" character varying`);
        await queryRunner.query(`ALTER TABLE "return_item" ADD "note" character varying`);
        await queryRunner.query(
