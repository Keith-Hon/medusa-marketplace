...
export abstract class AbstractPriceSelectionStrategy implements IPriceSelectionStrategy {
    public abstract withTransaction(manager: EntityManager): IPriceSelectionStrategy;

    public abstract calculateVariantPrice(variant_id: string, context: PriceSelectionContext): Promise<PriceSelectionResult>;
}
...
export function isPriceSelectionStrategy(
    ...
    return typeof object.calculateVariantPrice === "function" && typeof object.withTransaction === "function";
}
