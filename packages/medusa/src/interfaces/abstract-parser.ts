 ...
 */
export abstract class AbstractParser<TSchema, TParserResult, TParseOptions, TOutputResult> implements IParser<TParserResult, TParseOptions> {
    ...
    public abstract parse(readableStream: NodeJS.ReadableStream, options?: TParseOptions): Promise<TParserResult[]>;
