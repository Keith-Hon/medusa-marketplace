...
export default (app) => {
     ...
     */
    route.post("/:id/resend", middlewares.wrap(require("./resend-notification").default));
...
export const defaultAdminNotificationsFields = ["id", "resource_type", "resource_id", "event_name", "to", "provider_id", "created_at", "updated_at"];

export const allowedAdminNotificationsFields = ["id", "resource_type", "resource_id", "provider_id", "event_name", "to", "created_at", "updated_at"];
