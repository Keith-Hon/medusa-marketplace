...
export default (app) => {
    ...
    customerGroupRouter.delete("/", middlewares.wrap(require("./delete-customer-group").default));
    customerGroupRouter.post("/", middlewares.wrap(require("./update-customer-group").default));
    customerGroupRouter.get("/customers", middlewares.wrap(require("./get-customer-group-customers").default));
    customerGroupRouter.post("/customers/batch", middlewares.wrap(require("./add-customers-batch").default));
    customerGroupRouter.delete("/customers/batch", middlewares.wrap(require("./delete-customers-batch").default));
