...
export default async (req, res) => {
    ...
    await manager.transaction(async (tx) => {
        ...
        const created = await txRateService.create(omit(value, ["products", "product_types", "shipping_options"]));
        id = created.id;
    ...
    if (typeof id === "undefined") {
        throw new MedusaError(MedusaError.Types.UNEXPECTED_STATE, "Tax Rate was not created");
    }
