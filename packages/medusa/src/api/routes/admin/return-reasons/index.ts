...
export const defaultAdminReturnReasonsFields: (keyof ReturnReason)[] = ["id", "value", "label", "parent_return_reason_id", "description", "created_at", "updated_at", "deleted_at"];

export const defaultAdminReturnReasonsRelations: (keyof ReturnReason)[] = ["parent_return_reason", "return_reason_children"];
