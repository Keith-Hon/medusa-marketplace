...
describe("POST /admin/discounts", () => {
    ...
    describe("unsuccessful creation with dynamic discount using an invalid iso8601 duration", () => {
        ...
        it("returns error", () => {
            expect(subject.body.message).toEqual(`"valid_duration" must be a valid ISO 8601 duration`);
        });
    });
    ...
    describe("fails on invalid data", () => {
        ...
        it("returns error", () => {
            expect(subject.body.message).toEqual(`Invalid rule type, must be one of "fixed", "percentage" or "free_shipping"`);
        });
    });
    ...
    describe("fails on xor constraint for conditions", () => {
        ...
        it("returns error", () => {
            expect(subject.body.message).toEqual(`Only one of products, product_types is allowed, Only one of product_types, products is allowed`);
        });
    });
    ...
    describe("fails on invalid date intervals", () => {
        ...
        it("returns error", () => {
            expect(subject.body.message).toEqual(`"ends_at" must be greater than "starts_at"`);
        });
    });
