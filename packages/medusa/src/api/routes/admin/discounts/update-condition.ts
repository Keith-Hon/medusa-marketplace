...
export default async (req, res) => {
    ...
    const validatedCondition = await validator(AdminPostDiscountsDiscountConditionsCondition, req.body);

    const validatedParams = await validator(AdminPostDiscountsDiscountConditionsConditionParams, req.query);
    ...
    await manager.transaction(async (transactionManager) => {
        return await conditionService.withTransaction(transactionManager).upsertCondition(updateObj);
    });
