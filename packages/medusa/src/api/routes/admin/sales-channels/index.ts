...
export default (app) => {
    ...
    salesChannelRouter.get("/", middlewares.wrap(require("./get-sales-channel").default));
    salesChannelRouter.post("/", transformBody(AdminPostSalesChannelsSalesChannelReq), middlewares.wrap(require("./update-sales-channel").default));
    salesChannelRouter.delete("/", middlewares.wrap(require("./delete-sales-channel").default));
    salesChannelRouter.post("/", transformBody(AdminPostSalesChannelsSalesChannelReq), middlewares.wrap(require("./update-sales-channel").default));
    salesChannelRouter.delete("/products/batch", transformBody(AdminDeleteSalesChannelsChannelProductsBatchReq), middlewares.wrap(require("./delete-products-batch").default));
    ...
    route.post("/", transformBody(AdminPostSalesChannelsReq), middlewares.wrap(require("./create-sales-channel").default));
