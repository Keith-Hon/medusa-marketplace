...
describe("DELETE /admin/shipping-options/{id}", () => {
    describe("successful deletion", () => {
        ...
        beforeAll(async () => {
            subject = await request("DELETE", `/admin/shipping-options/${IdMap.getId("validId")}`, {
                adminSession: {
                    jwt: {
        ...
        it("calls service delete", () => {
            ...
            expect(ShippingOptionServiceMock.delete).toHaveBeenCalledWith(IdMap.getId("validId"));
        });
    });
});
