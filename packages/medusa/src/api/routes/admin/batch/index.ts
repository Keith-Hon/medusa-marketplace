...
import middlewares, { canAccessBatchJob, getRequestedBatchJob, transformQuery } from "../../../middlewares";
...
export default (app) => {
    ...
    batchJobRouter.post("/confirm", middlewares.wrap(require("./confirm-batch-job").default));

    batchJobRouter.post("/cancel", middlewares.wrap(require("./cancel-batch-job").default));
