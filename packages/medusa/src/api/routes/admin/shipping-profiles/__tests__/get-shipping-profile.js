...
const defaultFields = ["id", "name", "type", "created_at", "updated_at", "deleted_at", "metadata"];
...
describe("GET /admin/shipping-profiles/:profile_id", () => {
    describe("successful retrieval", () => {
        ...
        beforeAll(async () => {
            subject = await request("GET", `/admin/shipping-profiles/${IdMap.getId("validId")}`, {
                adminSession: {
                    jwt: {
        ...
        it("calls service retrieve", () => {
            ...
            expect(ShippingProfileServiceMock.retrieve).toHaveBeenCalledWith(IdMap.getId("validId"), {
