...
describe("POST /admin/shipping-profile", () => {
    describe("successful update", () => {
        ...
        beforeAll(async () => {
            subject = await request("POST", `/admin/shipping-profiles/${IdMap.getId("validId")}`, {
                payload: {
                    name: "Test option"
                },
                adminSession: {
        ...
        it("calls service method", () => {
            ...
            expect(ShippingProfileServiceMock.update).toHaveBeenCalledWith(IdMap.getId("validId"), {
                name: "Test option"
            });
        });
    });
