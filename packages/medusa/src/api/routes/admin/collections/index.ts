...
export default (app) => {
    ...
    route.post("/", transformBody(AdminPostCollectionsReq), middlewares.wrap(require("./create-collection").default));
    route.get(
        "/",
    ...
    collectionRouter.post("/", transformBody(AdminPostCollectionsCollectionReq), middlewares.wrap(require("./update-collection").default));
    collectionRouter.get("/", middlewares.wrap(require("./get-collection").default));
    collectionRouter.delete("/", middlewares.wrap(require("./delete-collection").default));
    collectionRouter.post("/products/batch", transformBody(AdminPostProductsToCollectionReq), middlewares.wrap(require("./add-products").default));
    collectionRouter.delete("/products/batch", transformBody(AdminDeleteProductsFromCollectionReq), middlewares.wrap(require("./remove-products").default));
