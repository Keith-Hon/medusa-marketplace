...
describe("POST /admin/regions/:region_id/fulfillment-providers", () => {
    describe("successful creation", () => {
        ...
        beforeAll(async () => {
            ...
            subject = await request("POST", `/admin/regions/${id}/fulfillment-providers`, {
                payload: {
        ...
        it("calls service addCountry", () => {
            ...
            expect(RegionServiceMock.addFulfillmentProvider).toHaveBeenCalledWith(IdMap.getId("testRegion"), "default_provider");
        });
    });
});
