...
describe("DELETE /admin/regions/:region_id/payment-providers/:provider_id", () => {
    describe("successful deletion", () => {
        ...
        beforeAll(async () => {
            ...
            subject = await request("DELETE", `/admin/regions/${id}/payment-providers/default_provider`, {
                adminSession: {
                    jwt: {
        ...
        it("calls service addCountry", () => {
            ...
            expect(RegionServiceMock.removePaymentProvider).toHaveBeenCalledWith(IdMap.getId("region"), "default_provider");
        });
    });
});
