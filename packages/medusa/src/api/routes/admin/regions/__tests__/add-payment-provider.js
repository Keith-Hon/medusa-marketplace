...
describe("POST /admin/regions/:region_id/payment-providers", () => {
    describe("successful creation", () => {
        ...
        beforeAll(async () => {
            ...
            subject = await request("POST", `/admin/regions/${id}/payment-providers`, {
                payload: {
        ...
        it("calls service addCountry", () => {
            ...
            expect(RegionServiceMock.addPaymentProvider).toHaveBeenCalledWith(IdMap.getId("testRegion"), "default_provider");
        });
    });
});
