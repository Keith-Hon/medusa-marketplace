...
export default (app, container) => {
    ...
    route.post("/password-reset", middlewares.wrap(require("./reset-password").default));

    route.post("/password-token", middlewares.wrap(require("./reset-password-token").default));
    ...
    route.post("/me/addresses", middlewares.wrap(require("./create-address").default));

    route.post("/me/addresses/:address_id", middlewares.wrap(require("./update-address").default));

    route.delete("/me/addresses/:address_id", middlewares.wrap(require("./delete-address").default));

    route.get("/me/payment-methods", middlewares.wrap(require("./get-payment-methods").default));

    return app;
};

export const defaultStoreCustomersRelations = ["shipping_addresses", "billing_address"];
...
export const allowedStoreCustomersRelations = ["shipping_addresses", "billing_address", "orders"];
