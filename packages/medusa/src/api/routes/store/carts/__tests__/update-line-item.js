...
describe("POST /store/carts/:id/line-items/:line_id", () => {
    describe("successfully updates a line item", () => {
        ...
        beforeAll(async () => {
            ...
            subject = await request("POST", `/store/carts/${cartId}/line-items/${lineId}`, {
                payload: {
                    quantity: 3
                }
            });
        ...
        it("calls cartService.updateLineItem", () => {
            ...
            expect(CartServiceMock.updateLineItem).toHaveBeenCalledWith(IdMap.getId("fr-cart"), IdMap.getId("existingLine"), {
    ...
    describe("removes line item on quantity 0", () => {
        ...
        it("calls CartService create", () => {
            ...
            expect(CartServiceMock.removeLineItem).toHaveBeenCalledWith(IdMap.getId("fr-cart"), IdMap.getId("existingLine"));
        });
