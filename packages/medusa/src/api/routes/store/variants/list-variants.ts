...
import { CartService, RegionService, ProductVariantService, PricingService } from "../../../../services";
...
export default async (req, res) => {
    ...
    const listConfig = {
        relations: expandFields.length ? expandFields : defaultStoreVariantRelations,
        skip: offset,
        take: limit
    };

    const filterableFields: FilterableProductVariantProps = omit(validated, ["ids", "limit", "offset", "expand", "cart_id", "region_id", "currency_code"]);
