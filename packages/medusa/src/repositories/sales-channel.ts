...
export class SalesChannelRepository extends Repository<SalesChannel> {
    ...
    async removeProducts(salesChannelId: string, productIds: string[]): Promise<DeleteResult> {
    ...
    async addProducts(salesChannelId: string, productIds: string[]): Promise<void> {
