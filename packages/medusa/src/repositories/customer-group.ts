...
export class CustomerGroupRepository extends Repository<CustomerGroup> {
    async addCustomers(groupId: string, customerIds: string[]): Promise<CustomerGroup> {
    ...
    async removeCustomers(groupId: string, customerIds: string[]): Promise<DeleteResult> {
