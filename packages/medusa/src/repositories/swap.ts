...
export class SwapRepository extends Repository<Swap> {
    public async findWithRelations(relations: Array<keyof Swap> = [], optionsWithoutRelations: Omit<FindManyOptions<Swap>, "relations"> = {}): Promise<Swap[]> {
    ...
    public async findOneWithRelations(relations: Array<keyof Swap> = [], optionsWithoutRelations: Omit<FindManyOptions<Swap>, "relations"> = {}): Promise<Swap> {
        // Limit 1
