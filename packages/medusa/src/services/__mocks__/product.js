...
export const ProductServiceMock = {
    ...
    updateOption: jest.fn().mockReturnValue(Promise.resolve(products.productWithOptions)),
    updateOptionValue: jest.fn().mockReturnValue(Promise.resolve()),
    deleteOption: jest.fn().mockReturnValue(Promise.resolve(products.productWithOptions)),
