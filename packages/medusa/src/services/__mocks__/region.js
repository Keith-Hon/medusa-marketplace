...
export const RegionServiceMock = {
    ...
    create: jest.fn().mockImplementation((data) => Promise.resolve({ id: "region" })),
    addCountry: jest.fn().mockImplementation((data) => Promise.resolve()),
    addFulfillmentProvider: jest.fn().mockImplementation((data) => Promise.resolve()),
    ...
    removeFulfillmentProvider: jest.fn().mockImplementation((data) => Promise.resolve()),
    removePaymentProvider: jest.fn().mockImplementation((data) => Promise.resolve()),
    update: jest.fn().mockImplementation((data) => Promise.resolve()),
    list: jest.fn().mockImplementation((data) => {
        return Promise.resolve([regions.testRegion, regions.regionFrance, regions.regionUs]);
    })
};
