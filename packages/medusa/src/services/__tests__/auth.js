...
describe("AuthService", () => {
    ...
    describe("authenticate", () => {
        ...
        it("returns success and user when passwords match", async () => {
            const result = await authService.authenticate("oliver@test.dk", "123456789");
        ...
        it("returns failure when passwords don't match", async () => {
            const result = await authService.authenticate("oliver@test.dk", "invalid-password");
    ...
    describe("authenticateCustomer", () => {
        ...
        it("returns success and user when passwords match", async () => {
            const result = await authService.authenticateCustomer("oliver@test.dk", "123456789");
        ...
        it("returns failure when passwords don't match", async () => {
            const result = await authService.authenticateCustomer("oliver@test.dk", "invalid-password");
