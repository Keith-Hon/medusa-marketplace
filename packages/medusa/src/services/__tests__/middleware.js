...
describe("MiddlewareService", () => {
    ...
    describe("addPostAuthentication", () => {
        ...
        it("fails when no function", () => {
            expect(() => middlewareService.addPostAuthentication("post", {})).toThrow("Middleware must be a function");
        });
    });
    ...
    describe("addPreAuthentication", () => {
        ...
        it("fails when no function", () => {
            expect(() => middlewareService.addPreAuthentication("pre", {})).toThrow("Middleware must be a function");
        });
    });
