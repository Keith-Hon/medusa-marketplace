...
describe("ProductCollectionService", () => {
    describe("retrieve", () => {
        ...
        it("successfully retrieves a product collection", async () => {
            const result = await productCollectionService.retrieve(IdMap.getId("bathrobe"));
        ...
        it("fails on non-existing product collection id", async () => {
            try {
                ...
                expect(error.message).toBe(`Product collection with id: non-existing was not found`);
            }
        });
    });
    ...
    describe("update", () => {
        ...
        it("fails on non-existing product collection", async () => {
            try {
                ...
                expect(error.message).toBe(`Product collection with id: ${IdMap.getId("test")} was not found`);
            }
        });
    });
