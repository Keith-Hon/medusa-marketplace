...
describe("TaxProviderService", () => {
    describe("retrieveProvider", () => {
        ...
        it("fails when payment provider not found", () => {
            ...
            try {
                ...
                expect(err.message).toEqual("Could not find a tax provider with id: unregistered");
            }
        });
    });
    ...
    describe("getTaxLines", () => {
        ...
        test("success", async () => {
            ...
            expect(container.lineItemTaxLineRepository.create).toHaveBeenCalledTimes(1);
            expect(container.lineItemTaxLineRepository.create).toHaveBeenCalledWith(expected[0]);

            expect(providerService.getRegionRatesForProduct).toHaveBeenCalledTimes(1);
            expect(providerService.getRegionRatesForProduct).toHaveBeenCalledWith("prod_1", region);
    ...
    describe("getRegionRatesForProduct", () => {
        ...
        test("success", async () => {
            ...
            expect(providerService.getCacheEntry).toHaveBeenCalledWith("prod_id", "reg_id");

            expect(providerService.setCache).toHaveBeenCalledTimes(1);
            expect(providerService.setCache).toHaveBeenCalledWith("prod_id", "reg_id", expected);
        });
        ...
        test("success - without product rates", async () => {
            ...
            expect(container.taxRateService.listByProduct).toHaveBeenCalledWith("prod_id", { region_id: "reg_id" });
    ...
    describe("getCacheKey", () => {
        ...
        test("formats correctly", () => {
            expect(providerService.getCacheKey("product", "region")).toEqual("txrtcache:product:region");
        });
    });
});
