...
describe("InviteService", () => {
    ...
    describe("token generation and validation", () => {
        ...
        it("validating a signed token succeeds", () => {
            const res = inviteService.verifyToken(inviteService.generateToken({ data: "test" }));
    ...
    describe("accept", () => {
        ...
        it("fails to accept an invite already accepted", async () => {
            ...
            await inviteService
                ...
                .catch((err) => {
                    expect(err).toEqual(new MedusaError(MedusaError.Types.INVALID_DATA, "Invalid invite"));
                });
        });
        ...
        it("fails to accept an with an existing user", async () => {
            ...
            await inviteService
                ...
                .catch((err) => {
                    expect(err).toEqual(new MedusaError(MedusaError.Types.INVALID_DATA, "User already joined"));
                });
        });
