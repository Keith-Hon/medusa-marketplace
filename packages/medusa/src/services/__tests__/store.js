...
describe("StoreService", () => {
    ...
    describe("addCurrency", () => {
        ...
        it("fails if currency not ok", async () => {
            await expect(storeService.addCurrency("1cd")).rejects.toThrow("Currency 1cd not found");
        });

        it("fails if currency already existis", async () => {
            await expect(storeService.addCurrency("dkk")).rejects.toThrow("Currency already added");
