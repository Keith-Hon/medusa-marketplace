...
describe("NotificationService", () => {
    ...
    describe("send", () => {
        it("successfully calls provider and saves noti", async () => {
            ...
            expect(container.noti_test.sendNotification).toHaveBeenCalledWith("event.test", { id: "test" }, null);
    ...
    describe("handleEvent", () => {
        it("cancels notification if no_notification is set", async () => {
            ...
            await notificationService.handleEvent(event, { id: "id", return_id: "id", no_notification: true });
