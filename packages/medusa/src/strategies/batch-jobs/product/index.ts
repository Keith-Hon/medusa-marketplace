...
export const productExportSchemaDescriptors = new Map<string, ProductExportColumnSchemaDescriptor>([
    [
        "Product ID",
        {
    ...
    [
        ...
        {
            accessor: (product: Product): string => product?.origin_country?.toString() ?? "",
            entityName: "product"
        }
    ],
    [
    ...
    [
        "Product Tags",
        {
            accessor: (product: Product): string => (product.tags.map((t) => t.value) ?? []).join(","),
            entityName: "product"
        }
    ],
    [
        ...
        {
            accessor: (product: Product): string => product?.discountable?.toString() ?? "",
            entityName: "product"
        }
    ],
    [
    ...
    [
        ...
        {
            accessor: (variant: ProductVariant): string => variant?.inventory_quantity?.toString() ?? "",
            entityName: "variant"
        }
    ],
    [
        ...
        {
            accessor: (variant: ProductVariant): string => variant?.allow_backorder?.toString() ?? "",
            entityName: "variant"
        }
    ],
    [
        ...
        {
            accessor: (variant: ProductVariant): string => variant?.manage_inventory?.toString() ?? "",
            entityName: "variant"
        }
    ],
    [
        "Variant Weight",
        {
            accessor: (variant: ProductVariant): string => variant?.weight?.toString() ?? "",
            entityName: "variant"
        }
    ],
    [
        "Variant Length",
        {
            accessor: (variant: ProductVariant): string => variant?.length?.toString() ?? "",
            entityName: "variant"
        }
    ],
    [
        "Variant Width",
        {
            accessor: (variant: ProductVariant): string => variant?.width?.toString() ?? "",
            entityName: "variant"
        }
    ],
    [
        "Variant Height",
        {
            accessor: (variant: ProductVariant): string => variant?.height?.toString() ?? "",
            entityName: "variant"
        }
    ],
    [
        "Variant HS Code",
        {
            accessor: (variant: ProductVariant): string => variant?.hs_code?.toString() ?? "",
            entityName: "variant"
        }
    ],
    [
        ...
        {
            accessor: (variant: ProductVariant): string => variant?.origin_country?.toString() ?? "",
            entityName: "variant"
        }
    ],
    [
    ...
    [
        "Variant Material",
        {
            accessor: (variant: ProductVariant): string => variant?.material?.toString() ?? "",
            entityName: "variant"
        }
    ]
]);
