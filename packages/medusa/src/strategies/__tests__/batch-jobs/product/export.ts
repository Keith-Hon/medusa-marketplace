...
describe("Product export strategy", () => {
    ...
    it("should prepare the job to be pre proccessed", async () => {
        ...
        const output1 = await productExportStrategy.prepareBatchJobForProcessing(fakeJob1, {} as Express.Request);
        ...
        const output2 = await productExportStrategy.prepareBatchJobForProcessing(fakeJob2, {} as Express.Request);
        ...
        expect(output2.context).toEqual(
            expect.objectContaining({
                list_config: {
                    ...
                    relations: [...defaultAdminProductRelations, "variants.prices.region"],
                    skip: 0,
                    take: 50
                },
