...
import { IsEnum, IsInt, IsOptional, IsString, Validate, ValidateIf, ValidateNested } from "class-validator";
...
export type UpdatePriceListInput = Partial<Pick<PriceList, "name" | "description" | "starts_at" | "ends_at" | "status" | "type">> & {
