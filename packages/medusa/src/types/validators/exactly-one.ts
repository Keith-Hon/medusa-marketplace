import { isDefined, ValidationArguments, ValidatorConstraint, ValidatorConstraintInterface } from "class-validator";
...
export class ExactlyOne implements ValidatorConstraintInterface {
    ...
    defaultMessage(args: ValidationArguments): string {
        return `Only one of ${args.property}, ${this.getFailedConstraints(args).join(", ")} is allowed`;
    }
