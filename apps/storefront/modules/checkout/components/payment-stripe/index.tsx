...
const PaymentStripe: React.FC = () => {
    const useOptions: StripeCardNumberElementOptions | StripeCardExpiryElementOptions | StripeCardCvcElementOptions = useMemo(() => {
        return {
            style: {
                base: {
...
const CardNumber = ({ options }: { options: StripeCardNumberElementOptions }) => {
    return (
