...
const LineItemPrice = ({ variant, region, quantity, style = "default" }: LineItemPriceProps) => {
        ...
        <div className="flex flex-col text-gray-700 text-right">
            ...
            {hasReducedPrice && (
                <>
                    ...
                    {style === "default" && <span className="text-rose-600">-{getPercentageDiff(variant.original_price, variant.calculated_price)}%</span>}
                </>
            )}
        </div>
    );
