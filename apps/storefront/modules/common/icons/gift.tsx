...
const Gift: React.FC<IconProps> = ({ size = "20", color = "currentColor", ...attributes }) => {
    return (
        <svg width={size} height={size} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...attributes}>
            <path d="M15.8337 9.58325V16.2499H4.16699V9.58325" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M17.5 6.25H2.5V9.58333H17.5V6.25Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
