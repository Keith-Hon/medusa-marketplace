...
const EditAddress: React.FC<EditAddressProps> = ({ address, isActive = false }) => {
    ...
    return (
        <>
            <div
                className={clsx("border border-gray-200 p-5 min-h-[220px] h-full w-full flex flex-col justify-between transition-colors", {
            ...
            <Modal isOpen={state} close={close}>
                ...
                <Modal.Body>
                    <div className="grid grid-cols-1 gap-y-2">
                        ...
                        />
                        <Input label="Apartment, suite, etc." {...register("address_2")} errors={errors} autoComplete="address-line2" />
