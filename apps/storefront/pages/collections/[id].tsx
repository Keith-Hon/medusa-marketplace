...
export const fetchCollectionProducts = async ({ pageParam = 0, id, cartId }: { pageParam?: number; id: string; cartId?: string }) => {
...
export const getStaticProps: GetStaticProps = async (context) => {
    ...
    await queryClient.prefetchInfiniteQuery(["get_collection_products", id], ({ pageParam }) => fetchCollectionProducts({ pageParam, id }), {
